...
// user detail
  ...
  //static NavDogModel? naveBarDogIndex;
  ...
  //   return null;
  // }
  // static List<NavDogModel> dogList =   [
  //
  //   NavDogModel(avatarDog: AppImages.dog3, navDog: AppImages.dog4),
  //   NavDogModel(avatarDog: AppImages.dog7, navDog: AppImages.dog8),
  //   NavDogModel(avatarDog: AppImages.dog5, navDog: AppImages.dog6),
  //   NavDogModel(avatarDog: AppImages.dog11, navDog: AppImages.dog12),
  //   NavDogModel(avatarDog: AppImages.dog27, navDog: AppImages.dog26),
  //
  // ];
}
